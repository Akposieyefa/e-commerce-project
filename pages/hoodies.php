...
use app\classes\Hoodies;

$pdo = new Connection();
$hoodies = new Hoodies($pdo);
                                        ...
                                        <div class="card-body">
                                            <div class="shop__sidebar__categories">
                                                <ul class="nice-scroll">
                                                    <?php $categories = $hoodies->categories(); ?>
                ...
                <div class="col-lg-9">
                    <div class="shop__product__option">
                        ...
                        <?php  $slug = $_GET['category']; ?>    
                            <p><?= $hoodies->product_results($slug,$setLimit,$page); ?></p>
                        <?php else: ?>
                             <?php  $slug = ''; ?>  
                            <p><?= $hoodies->product_results($slug,$setLimit,$page); ?></p>
                        <?php endif; ?>
                    ...
                    <div class="row">
                        <?php if(isset($_GET['category'])): ?>
                        <?php  $slug = $_GET['category']; 
                            if ($products = $hoodies->get_category_products($slug,[$pageLimit, $setLimit])): ?>
                        ...
                        <?php $products = $hoodies->index([$pageLimit, $setLimit]); ?>
                        <?php foreach ($products as $product): ?>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="/clothmax/assets/<?= $product->productPicture; ?>">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <?php if(isset($_GET['category'])): ?>
                        <?php   $slug = $_GET['category']; ?>
                            <?= $hoodies->displayPaginationBelow($slug,$setLimit,$page); ?>
                        <?php else: ?>
                             <?php  $slug = ''; ?>  
                            <?= $hoodies->displayPaginationBelow($slug,$setLimit,$page); ?>
                        <?php endif; ?>
