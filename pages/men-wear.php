                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <div class="shop__sidebar__categories">
                                                <ul class="nice-scroll">
                                                    <?php $subcategories = $men->subcategories(['men-wear']); ?>
                                                    <?php foreach($subcategories as $subcategory): ?>
                                                    <?= '<li><a href="/clothmax/pages/men-wear.php?category='.$subcategory->subCategorySlug.'">'.ucwords($subcategory->subCategoryName).'</a></li>' ; ?>
                ...
                <div class="col-lg-9">
                    <div class="shop__product__option">
                        ...
                        <?php  $slug = $_GET['category']; ?>    
                            <p><?= $men->product_results($slug,$setLimit,$page); ?></p>
                        <?php else: ?>
                             <?php  $slug = ''; ?>  
                            <p><?= $men->product_results($slug,$setLimit,$page); ?></p>
                        <?php endif; ?>
                    ...
                    <div class="row">
                        <?php if(isset($_GET['category'])): ?>
                        <?php  $slug = $_GET['category']; 
                            if ($products = $men->get_category_products($slug,[$pageLimit, $setLimit])): ?>
                        ...
                        <?php $products = $men->index([$pageLimit, $setLimit]); ?>
                        <?php foreach ($products as $product): ?>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="/clothmax/assets/<?= $product->productPicture; ?>">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <?php if(isset($_GET['category'])): ?>
                        <?php   $slug = $_GET['category']; ?>
                            <?= $men->displayPaginationBelow($slug,$setLimit,$page); ?>
                        <?php else: ?>
                             <?php  $slug = ''; ?>  
                            <?= $men->displayPaginationBelow($slug,$setLimit,$page); ?>
                        <?php endif; ?>
