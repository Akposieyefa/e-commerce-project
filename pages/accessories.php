...
use app\classes\Accessories;

$pdo = new Connection();
$accessories = new Accessories($pdo);
                                        ...
                                        <div class="card-body">
                                            <div class="shop__sidebar__categories">
                                                <ul class="nice-scroll">
                                                    <?php $categories = $accessories->categories(); ?>
                ...
                <div class="col-lg-9">
                    <div class="shop__product__option">
                        ...
                        <?php  $slug = $_GET['category']; ?>    
                            <p><?= $accessories->product_results($slug,$setLimit,$page); ?></p>
                        <?php else: ?>
                             <?php  $slug = ''; ?>  
                            <p><?= $accessories->product_results($slug,$setLimit,$page); ?></p>
                        <?php endif; ?>
                    ...
                    <div class="row">
                        <?php if(isset($_GET['category'])): ?>
                        <?php  $slug = $_GET['category']; 
                            if ($products = $accessories->get_category_products($slug,[$pageLimit, $setLimit])): ?>
                        ...
                        <?php $products = $accessories->index([$pageLimit, $setLimit]); ?>
                        <?php foreach ($products as $product): ?>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="/clothmax/assets/<?= $product->productPicture; ?>">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <?php if(isset($_GET['category'])): ?>
                        <?php   $slug = $_GET['category']; ?>
                            <?= $accessories->displayPaginationBelow($slug,$setLimit,$page); ?>
                        <?php else: ?>
                             <?php  $slug = ''; ?>  
                            <?= $accessories->displayPaginationBelow($slug,$setLimit,$page); ?>
                        <?php endif; ?>
